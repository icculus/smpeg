...
void MPEGaudio_computebuffer_2 (REAL *fraction, REAL buffer[2][CALCBUFFERSIZE])
{
  ...
  hcos_64 = self->hcos_64;
  hcos_32 = self->hcos_32;
  hcos_16 = self->hcos_16;
  hcos_8 = self->hcos_8;
...
{
  MPEGaudio_computebuffer_2(self,fractionL,calcbufferL);
  if(!self->outputstereo) MPEGaudio_generatesingle_2(self);
  else
  {
    MPEGaudio_computebuffer_2(self,fractionR,calcbufferR);
