...
void
MPEGaudio_computebuffer (_THIS, REAL *fraction,REAL buffer[2][CALCBUFFERSIZE])
{
...
void
MPEGaudio_generatesingle (_THIS)
{
  int i;
  register REAL r, *vp;
...
void
MPEGaudio_subbandsynthesis (_THIS, REAL *fractionL,REAL *fractionR)
{
