...
void
MPEGaudio_computebuffer_2 (_THIS, REAL *fraction,REAL buffer[2][CALCBUFFERSIZE])
{
...
void
MPEGaudio_generatesingle_2 (_THIS)
{
  int i;
  register REAL r, *vp;
...
void
MPEGaudio_subbandsynthesis_2 (_THIS, REAL *fractionL,REAL *fractionR)
{
